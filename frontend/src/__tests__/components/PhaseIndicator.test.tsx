...
describe("PhaseIndicator", () => {
  describe("RAPPORT phase", () => {
    it("shows first phase active", () => {
      render(<PhaseIndicator phase="RAPPORT" phaseLabel="正在建立连接..." />);
  ...
  describe("EXPLORATION phase", () => {
    it("shows second phase active", () => {
      render(<PhaseIndicator phase="EXPLORATION" phaseLabel="深入探索中..." />);
  ...
  describe("CONFRONTATION phase", () => {
    it("shows third phase active", () => {
      render(<PhaseIndicator phase="CONFRONTATION" phaseLabel="核心对峙..." />);
  ...
  describe("SYNTHESIS phase", () => {
    it("shows fourth phase active", () => {
      render(<PhaseIndicator phase="SYNTHESIS" phaseLabel="整理画像..." />);
  ...
  describe("phase icons", () => {
    it("renders all four phase step numbers", () => {
      render(<PhaseIndicator phase="RAPPORT" phaseLabel="连接中" />);
